...
@rem ##########################################################################
@rem
@rem  scan.cli.GUI startup script for Windows
@rem
@rem ##########################################################################
...
set SCAN_CLI_OPTS=-Done-jar.main.class=com.blackducksoftware.scan.cli.impl.ScanClient2 -Done-jar.silent=true -Done-jar.jar.path="%APP_HOME%\lib\cache\scan.cli.impl-standalone.jar" %SCAN_CLI_OPTS%
...
set CLASSPATH=%APP_HOME%\lib\scan.cli-3.0.1-standalone.jar
